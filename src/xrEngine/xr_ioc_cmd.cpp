...
// [DA_PORT] ОБЩИЙ ВЫКЛЮЧАТЕЛЬ НАШЕЙ ДЫМКИ. 1 - работает, 0 - стоковый туман мода.
//
...
ENGINE_API int ps_da_fog_enable = 1;
...
void CCC_Register()
{
    ...
    CMD4(CCC_DaDebugInteger, "r__light_probe", &ps_da_light_probe, 0, 6);      // [DA_PORT]
    ...
    CMD4(CCC_Integer, "r__fog", &ps_da_fog_enable, 0, 1);                        // [DA_PORT]

...
Ориентир по релизу для мододелов — **10 августа**. Документ отражает состояние на 28 июля.
...
**Перенос.** 864 правки в 193 файлах — полный список в `02_PORT_CHANGES.md`. Крупное: слоты инвентаря
...
скелетную анимацию, и на них — FSR 2, FSR 3 и XeSS. Подробности и ограничения: `09_UPSCALERS.md`.
...
- батарейная фича: у автора артефакты работают только при наличии батареи в слоте, в порте нет ни
  ...
  механикой батарей;
- **DLSS** — данные для него уже есть (векторы движения, дрожание, экспозиция), осталась интеграция
  NGX и лицензия NVIDIA. Смысл: XeSS на DX11 работает только на Intel Arc, так что универсальный
  апскейлер сейчас ровно один — FSR 2. DLSS закрыл бы владельцев RTX;

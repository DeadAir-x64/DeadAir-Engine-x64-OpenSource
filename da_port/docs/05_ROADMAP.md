...
**Перенос.** 954 правки в 200 файлах — полный список в `02_PORT_CHANGES.md`. Крупное: слоты инвентаря
...
стволов у НПС после мародёрства и отсутствие поломок от стрельбы (так задумано автором); отдача,
разброс и урон по классам брони; ближний бой;
